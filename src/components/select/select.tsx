...
import { Container, Input, Label, ListOptions,COption as Option } from './select.styled'
...
const TopSelect:FC<ISelectProps> = ({arrOptions,setValue,defaultLabel,value,height,width}) => {
