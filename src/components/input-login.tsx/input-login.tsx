...
export const InputLogin:React.FC<{value:string,setValue:any,error:boolean,setError:any}> 
...
console.log(firstSymbol)
  return (
    ...
    beforeMaskedValueChange={(values, oldState, userInput)=>{
        ...
        return {
            value:inputVal,
            selection:{start:values.selection.start+1,end:values.selection.end+1}
        }
    }}
    formatChars={formatChars}
    className='input-login'
    maskChar={''}
    mask={defineMask} value={value}
  />
  )
}
